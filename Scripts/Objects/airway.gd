...
const airway_texture = preload("res://Assets/Textures/Model/Airline/airline_alpha.svg")
const arrow_texture = preload("res://Assets/Textures/Model/Airline/airline_arrow.svg")
