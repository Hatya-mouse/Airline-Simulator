...
const hint_box_scene = preload("res://Scenes/Objects/UI/Control/Panel/hint_box.tscn")
const scroll_container_scene = preload("res://Scenes/Objects/UI/Control/Panel/info_box_scroll_container.tscn")

const button_scene = preload("res://Scenes/Objects/UI/Control/Button/text_button.tscn")
const checkbox_scene = preload("res://Scenes/Objects/UI/Control/Button/check_box.tscn")
const property_scene = preload("res://Scenes/Objects/UI/Control/Label/property_label.tscn")
const spacer_scene = preload("res://Scenes/Objects/UI/Control/InfoBox/info_box_spacer.tscn")
const label_scene = preload("res://Scenes/Objects/UI/Control/InfoBox/info_box_label.tscn")
